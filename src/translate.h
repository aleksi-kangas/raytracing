...
class Translate : public Collidable {
 public:
  Translate(std::shared_ptr<Collidable> object, const Vector3D &translation);

  /**
   * Compute collision of a ray and the translated object.
  ...
  /**
   * Compute a minimum AABB that surrounds the translated object.
